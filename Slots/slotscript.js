   ...
   const MEMES = [
    {
      ...
      name: "Мост через Обь",
      emoji: "🌉",
      history: "Сургутский вантовый мост — один из самых длинных однопилонных мостов в мире. Его единственный пилон высотой 150 метров местные шутливо называют «иглой Сургута». В мемах мост стал символом того, как город «висит на одной ниточке», но держится крепко.",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Surgut_bridge.jpg/960px-Surgut_bridge.jpg" }
    },
    {
      id: 2,
      name: "Газ-факел",
      emoji: "🔥",
      history: "Факелы попутного газа над Сургутом породили мем «у нас вместо солнца — факел». Жители шутят, что зимой можно греться у горизонта. Этот образ стал визитной карточкой нефтегазовой столицы.",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Gas_flare.jpg/960px-Gas_flare.jpg" }
    },
    {
      id: 3,
      name: "−50 на улице",
      emoji: "🥶",
      history: "Мем «сургутское лето длится две недели, остальное — зима». Когда термометр показывает −50°C, горожане выкладывают фото замёрзшего кофе и подписывают «погодка шепчет». Мороз стал поводом для гордости и юмора.",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Frost_on_window.jpg/960px-Frost_on_window.jpg" }
    },
    {
      id: 4,
      name: "Энергия Сибири",
      emoji: "⚡",
      history: "Сургутская ГРЭС-2 — одна из крупнейших тепловых электростанций мира. Мем «Сургут заряжает всю страну» обыгрывает, что именно отсюда идёт энергия. Картинки с гигантскими трубами стали локальным символом мощи.",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Power_station.jpg/960px-Power_station.jpg" }
    },
    {
      id: 5,
      name: "Чёрное золото",
      emoji: "🛢️",
      history: "Нефтяная качалка — главный персонаж сургутских мемов. «Качалка качает, а зарплата нет» — народная шутка о контрасте богатства недр и быта. Силуэт станка-качалки давно стал неофициальным гербом.",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Pumpjack.jpg/960px-Pumpjack.jpg" }
    },
    {
      id: 6,
      name: "Полярная ночь",
      emoji: "🌌",
      history: "Хотя Сургут не за полярным кругом, короткий зимний день породил мем «вышел на работу в темноте — вернулся в темноте». Фото фонарей в 3 часа дня собирают тысячи лайков с подписью «доброе утро, Сургут».",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Aurora_Borealis.jpg/960px-Aurora_Borealis.jpg" }
    },
    {
      id: 7,
      name: "Комар-патриот",
      emoji: "🦟",
      history: "Сибирский комар — герой летних мемов. «Сургутский комар поднимает человека» — гипербола о размере и наглости насекомых. Комар в шутку признан «неофициальной птицей региона».",
      media: { type: "image", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Mosquito_2007-2.jpg/960px-Mosquito_2007-2.jpg" }
    }
  ];
  /* ============================================================ */
